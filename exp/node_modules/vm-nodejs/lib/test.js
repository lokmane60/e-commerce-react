...
describe('a NodeJS emulator', () => {
    it('can require a script', () => {
        ...
        chai_1.expect(mod.id).to.equal(fs.realpathSync(path.join(SNIPPETS_DIR, 'test_mod.js')));
        chai_1.expect(mod.exports).to.deep.equal({ foo: 42 });
    });
    it('supports cyclic dependencies', () => {
        ...
        chai_1.expect(a.exports.done).to.be.true;
        chai_1.expect(b.exports.done).to.be.true;
    });
    it('reports correct __dirname and __filename', () => {
        const node = new NodeVM();
        const mod = node.getModule(path.join(SNIPPETS_DIR, './test_locals'));
        chai_1.expect(mod.exports.__dirname).to.equal(SNIPPETS_DIR);
        chai_1.expect(mod.exports.__filename).to.equal('test_locals.js');
    });
    it('has a working require.resolve()', () => {
        const node = new NodeVM();
        const mod = node.getModule(path.join(SNIPPETS_DIR, './test_locals'));
        chai_1.expect(mod.exports.require.resolve('./test_mod_a')).to.equal(path.join(SNIPPETS_DIR, 'test_mod_a.js'));
    });
    it('caches modules', () => {
        const node = new NodeVM();
        ...
        chai_1.expect(mod1.exports).to.equal(1);
        chai_1.expect(mod2.exports).to.equal(1);
    });
    it('can evict an entry from the cache', () => {
        const node = new NodeVM();
        const mod1 = node.getModule(path.join(SNIPPETS_DIR, './test_evict'));
        chai_1.expect(mod1.exports).to.equal(2);
    });
    ...
    it('can reload a cyclic dependency', () => {
        ...
        chai_1.expect(mod.exports.foo).to.equal(1);
        chai_1.expect(mod.exports.b.foo).to.equal(2);
        chai_1.expect(mod.exports).to.equal(mod.exports.b.a);
        chai_1.expect(mod.exports.b).to.equal(mod.exports.b.a.b);
        ...
        chai_1.expect(mod2.exports.foo).to.equal(3);
        chai_1.expect(mod2.exports.b.foo).to.equal(4);
        chai_1.expect(mod2.exports).to.equal(mod2.exports.b.a);
        chai_1.expect(mod2.exports.b).to.equal(mod2.exports.b.a.b);
    });
